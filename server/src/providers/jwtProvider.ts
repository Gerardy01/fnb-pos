...
export interface IJwtProvider {
    ...
    generateRefreshToken(expiresIn : string) : Promise<string>;
...
export class JsonWebTokenJwtProvider implements IJwtProvider {
    ...
    async generateRefreshToken(expiresIn: string): Promise<string> {
        return jwt.sign({}, "refreshTokenSecret", { expiresIn: expiresIn })
    }
